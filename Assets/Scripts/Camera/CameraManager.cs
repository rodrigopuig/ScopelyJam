...
public class CameraManager : MonoBehaviour
{
    ...
    [Header("Zoom")]
    [SerializeField, Tooltip("Cam z pos when players are furthest apart")] float maxZPos = -12;
    [SerializeField, Tooltip("Cam z pos when players are closest")] float minZPos = 8;
    [SerializeField, Tooltip("Margin on the side of each player")] float hMargin = 10;
    [SerializeField] AnimationCurve zPosCurve;
    [SerializeField, Tooltip("Max Distance possible between players")] float maxXDistance = 40;
